...
const items = [
  ...
  },
  {
    ...
    title: "Allergy-Friendly Directory",
    description:
      "Be available and present in an allergy-friendly restaurant directory",
    imageLight:
  ...
  },
  {
    ...
    description:
      "Add, edit, and delete menu items from our mobile web application.",
    imageLight:
  ...
  {
    icon: <ArticleRounded />,
    title: "Customizable allergy-focused landing page",
    description: "Custom landing page for allergy menu & filters.",
    imageLight:
      'url("/static/images/templates/templates-images/devices-light.png")',
    imageDark:
      'url("/static/images/templates/templates-images/devices-dark.png")',
